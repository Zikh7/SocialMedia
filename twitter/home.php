	...
	<div class="nav">
		...
		<div class="nav-left">
			<ul>
				...
				<li><a href="#"><i class="fa fa-envelope" aria-hidden="true"></i>Messages</li>
			</ul>
		</div><!-- nav left ends-->
						 ...
						 <div class="tweet-footer">
						 	<div class="t-fo-left">
						 		<ul>
						 			...
						 			<span class="tweet-error"><?php if(isset($error)){echo $error;}else if(isset($iamgeError)){echo $iamgeError;} ?></span>
						 			</li>
						 		</ul>
						 	</div>
